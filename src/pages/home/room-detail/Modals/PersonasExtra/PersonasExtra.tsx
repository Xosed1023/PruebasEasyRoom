...
import { TiposPagos, useAgregarPersonasExtraMutation, useGetAreasQuery, useGetColaboradoresByAreasLazyQuery } from "src/gql/schema"
    ...
    return (
        ...
        >
            <FormProvider {...methods}>
                <form 
                    className={cx("modal__personas-extra__container",
                            isInitialModalViewState ? "" : state.visible ?
                            "persona-extra__body-trigger--left" : "persona-extra__body-trigger--right"
