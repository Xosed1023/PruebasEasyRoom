        ...
        agregaHoras({
            ...
            onCompleted: async (responseData) => {
                if (responseData) {
                    ...
                    const { ticket_id, extra_id } = responseData.agregar_horas_renta
                    ...
                    <ModalContent style={{flex: "0 0 100%"}}>
                        <ModalRow className="horas-extra__header">
                            ...
                            <p className="horas-extra__header__end-date">
                                Salida {formatCustomDate(addHours(endDate || new Date(), horasExtra), "MMM, DD YYYY - h:mm A")}
                            </p>
                        </ModalRow>
                        <ModalBody className="horas-extra__body">
                            ...
                            {rolName !== RoleNames.valet && tipoPago === "total" && (
                                <div className="noches-extra__body-pago-total">
                                    ...
                                    {paymentMethod === PAYMENT_METHODS.lovePoints.value && (
                                        <div className="pay-input-half-width horas-extra__body-love-points lovepoints-extra-wrapper">
                                            <LovePointsInput
                                                index={0}
                                                setLovePointsAmount={setLovePointsAmount}
                                                className="horas-extra__body-love-points"
                                            />
                                        </div>
                                    )}
                                    {paymentMethod !== PAYMENT_METHODS.lovePoints.value &&
