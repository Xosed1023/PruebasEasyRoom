    ...
    const createIncidencia = async () => {
        ...
        createIncidence({
            ...
            onCompleted: ({ crear_incidencia }) => {
                ...
                let message = `Se registró la incidencia con **folio ${
                    crear_incidencia.folio
                }, el día ${formatCustomDate(crear_incidencia.fecha_registro, "MMM, DD YYYY - h:mm A")}.**`
