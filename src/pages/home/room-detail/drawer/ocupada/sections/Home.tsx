        ...
        ...(room?.colaborador_tareas_sin_finalizar?.length
            ...
            : [
                ...
                },
                {
                    label: "Cancelaciones",
                    disabled:
                    !room?.ultima_renta?.es_renta_cancelable && !room?.ultima_renta?.tiene_ventas_cancelables,
                    onClick: validateIsColabActive(() => {
                    ...
                    <div className="room-detail--occupied__container">
                        <Block>
                            <div>
                                {!room?.colaborador_tareas_sin_finalizar?.length ? (
                                    <AvatarProgressCard
                                        progressbarDescriprionBottom={`Entrada: ${formatCustomDate(
                                            ...
                                            .replace("pm", "p.m.")
                                            .toLowerCase()}`}
                                        timeLimit={parseISOToDate(room?.ultima_renta?.fecha_condensada) ?? new Date()}
                                        timeStart={parseISOToDate(room?.ultima_renta?.fecha_registro) ?? new Date()}
                                        daysLabel="noche"
                                    />
                                ) : (
                                    <AvatarProgressCard
