                        ...
                        ?.map((pago, index, pagosFiltrados) => {
                            ...
                            return (
                                <ItemPayment
                                    ...
                                    dateBottomText={
                                        pago?.fecha_pago
                                            ? formatDateWithTime(UTCStringToLocalDate(pago.fecha_pago))
                                            : "-"
                                    }
                                />
                            )
                        ...
                        .map((e) => {
                            ...
                            return (
                                <ItemPayment
                                    ...
                                    printBottom
                                    dateBottomText={
                                        e.fecha_pago ? formatDateWithTime(UTCStringToLocalDate(e.fecha_pago)) : "-"
                                    }
                                />
                            )
                        })}
                        ...
                        .map((o) => {
                            ...
                            return (
                                <ItemPayment
                                    ...
                                    dateBottomText={
                                        ultimaFechaPago
                                            ? formatDateWithTime(UTCStringToLocalDate(ultimaFechaPago.toISOString()))
                                            : "-"
                                    }
                                />
                            )
                                ...
                                ...(data?.habitacion?.ultima_renta?.ordenes
                                    ...
                                    .map((o) => ({
                                        ...
                                        date: o.fecha_registro
                                            ? formatDateWithTime(UTCStringToLocalDate(o.fecha_registro))
                                            : "",
                                    })) || []),
                            ]}
                            showAmounts
                    ...
                    {data?.habitacion?.ultima_renta?.extras
                        ...
                        .map((extra) => (
                            <ItemPayment
                                ...
                                dateBottom
                                dateBottomText={
                                    extra?.fecha_pago ? formatDateWithTime(UTCStringToLocalDate(extra.fecha_pago)) : "-"
                                }
                            />
                        ))}
                                ...
                                <ItemPayment
                                    ...
                                    dateBottomText={
                                        orden?.fecha_registro
                                            ? formatDateWithTime(UTCStringToLocalDate(orden.fecha_registro))
                                            : "-"
                                    }
                                />
                            )
