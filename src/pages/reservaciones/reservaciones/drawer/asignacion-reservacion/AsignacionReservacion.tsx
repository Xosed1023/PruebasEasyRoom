                    ...
                    <Description
                        ...
                        value1={`${
                            sentReservaD?.fecha_entrada
                                ? formatCustomDate(new Date(sentReservaD?.fecha_entrada), "D MMM YYYY")
                                : ""
                        } - ${
                            sentReservaD?.fecha_salida
                                ? formatCustomDate(new Date(sentReservaD?.fecha_salida), "D MMM YYYY")
                                : ""
                        }`}
                    />
                )}
