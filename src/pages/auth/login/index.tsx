...
export function Form(): JSX.Element {
    ...
    return (
        <form className="login-screen__form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <LoginFingerprint handleColaboradorInactive={() => setisModalColabInactiveOpen(true)} rememberSession={rememberSession} onClose={() => setisModalLoginHuellaOpen(false)} isOpen={isModalLoginHuellaOpen} />
        </form>
    )
}
