        ...
        <Controller
            ...
            render={({ field: { value }, fieldState: { error } }) => (
                <Dropdown
                    ...
                    iconInOptions={false}
                    errorHintText={error ? "Selecciona una opción" : ""}
                    testId="detalle-compra-tipo-pago"
                    onClick={({ value }) => {
                ...
                render={({ field: { value, onChange }, fieldState: { error } }) => (
                    <>
                        <Dropdown
                            ...
                            iconInOptions={false}
                            keyboardNavigation
                            testId="detalle-compra-metodo-pago"
                            onClick={({ value }) => {
                                onChange(value)
                                appenedCost()
                ...
                render={({ field: { value, onChange }, fieldState: { error } }) => {
                    return (
                        <InputCardNumber
                            ...
                            testId="detalle-compra-input-card"
                        />
                    )
                }}
            />
        ...
        <Controller
            ...
            render={({ field: { onChange, value }, fieldState: { error } }) => (
                <InputPersonal
                    ...
                    testId="detalle-compra__input-colaborador"
                />
            )}
        />
    ) : null
        ...
        <Controller
            ...
            render={({ field: { onChange, value }, fieldState: { error } }) => (
                <InputPersonal
                    ...
                    testId="detalle-compra__input-personal-consumo-interno"
                />
            )}
        />
    ) : null
                ...
                render={({ field: { value, onChange }, fieldState: { error } }) => {
                    return (
                        <InputAbonarEasyRewards
                            ...
                            setLovePointsAmount={setLovePointsAmount}
                            lovePointsAmount={lovePointsAmount}
                            testId="detalle-compra__input-easyrewards"
                        />
                    )
                }}
            />
