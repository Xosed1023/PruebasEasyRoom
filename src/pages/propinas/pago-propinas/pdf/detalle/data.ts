...
import { usePDFParams } from "./../hooks/params"
...
export function useData() {
    ...
    const dates = useMemo(
        () => [
            { label: "Fecha inicio", value: formatDateComplitSlash(fecha_inicio) },
            { label: "Fecha término", value: formatDateComplitSlash(fecha_fin || fecha_inicio) },
