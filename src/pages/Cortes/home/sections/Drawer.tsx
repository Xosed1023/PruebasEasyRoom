...
import { PAYMENT_TYPES } from "../data/Cortes.constants"
                    ...
                    <DescriptionDetail
                        ...
                        value={
                            data?.ticket?.fecha_impresion
                                ? formatCustomDate(getExactDate(data?.ticket?.fecha_impresion), "DD/MMM/YY hh:mm a")
                                : "-"
                        }
                    />
                    <DescriptionDetail
                        ...
                        value={
                            data?.ticket?.fecha_cancelacion
                                ? formatCustomDate(getExactDate(data.ticket.fecha_cancelacion), "DD/MMM/YY hh:mm a")
                                : "-"
                        }
                    />
                    <DescriptionDetail
