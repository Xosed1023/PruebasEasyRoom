...
import ControlVehicular from "./control-vehicular/ControlVehicular"
...
const routesHabitacion = [
    { path: "venta-habitacion/:habitacion_id", element: <CurrentdateProvider><VentaHabitacion /></CurrentdateProvider> },
        ...
        <Routes>
            ...
            >
                ...
                {rolName === RoleNames.valet && (
                    <>
                        <Route path="venta-habitacion/:habitacion_id" element={<CurrentdateProvider><VentaHabitacion /></CurrentdateProvider>} />
