...
const Huespedes = ({ apiDateFilter }: { apiDateFilter: string[] | null }) => {
    ...
    const tableItems: FlexibleTableRow[] = data?.respuesta.tabla_ventas_articulos?.map((hab, index) => ({
        value: [
            { value: hab.tipo_entrada, className: "reports-cell" },
            ...
            { value: hab.consumo_renta, className: "reports-cell" },
            { value: hab.consumo_reserva, className: "reports-cell" },
            { value: hab.consumo_extras, className: "reports-cell" },
            { value: hab.consumo_restaurante, className: "reports-cell" },
            { value: hab.consumo_room_service, className: "reports-cell" },
            {
                value: sum([
                    hab.consumo_renta,
                    hab.consumo_reserva,
