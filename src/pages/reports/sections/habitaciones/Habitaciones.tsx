...
const Habitaciones = ({ apiDateFilter }: { apiDateFilter: string[] | null }) => {
    ...
    useEffect(() => {
        setSelectedSection(ReportsOptions.habs)
    }, [])
        ...
        <ReportWrapper height="calc(100dvh - 125px)">
            {load ? (
                ...
                <CardReports>
                    ...
                    <CardReport title={"No. de reservas"} value={data?.dashboard?.reservada || 0} />
                    <CardReport title={"No. de limpiezas"} value={data?.dashboard?.limpieza || 0} />
