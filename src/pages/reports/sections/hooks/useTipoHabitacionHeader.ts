...
const useTipoHabitacionesHeader = <T extends string>({
    headerValue,
    valueToDisplay,
    ...
    const options = [...(data?.tipo_habitaciones.map((th) => ({ value: th.nombre, valueToDisplay: th.nombre })) || [])]
...
export default useTipoHabitacionesHeader
