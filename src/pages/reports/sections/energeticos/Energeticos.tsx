...
const Energeticos = (
    ...
    const tableItems: FlexibleTableRow[] = data?.respuesta.tabla_mantto?.map((energetico, index) => ({
        value: [
            ...
            { value: (energetico.agua + "L") || "-", className: "reports-cell" },
            { value: (energetico.gas + "m³") || "-", className: "reports-cell" },
            { value: (energetico.luz + "kW") || "-", className: "reports-cell" },
    ...
    useEffect(() => {
        setSelectedSection(ReportsOptions.energeticos)
    }, [])
