...
export interface AvatarStackProps
    ...
    avatarSize?: number
    noAvatarLengthFallback?: React.ReactNode
}
    ...
    return (
        ...
        >
            {limitedAvatars.map((avatarUrl, index) => (
                <Avatar size={avatarSize} key={index} className={avatarStackVariants()}>
            ...
            {limitedAvatars.length < avatars.length ? (
                <Avatar size={avatarSize} key={"Excesive avatars"}>
