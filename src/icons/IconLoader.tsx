...
const IconLoader = ({ color = "#000", ...props }: IconProps) => {
    return (
        <svg className="animate-spin" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <g clipPath="url(#clip0_3288_32159)">
                <path
                    ...
                    fill="url(#paint0_linear_3288_32159)"
                />
            </g>
            <defs>
                <linearGradient
                    id="paint0_linear_3288_32159"
                    x1="12"
                    y1="3"
                    x2="12"
                    y2="21"
                ...
                >
                    ...
                    <stop offset="1" stopColor="#AA95DC" />
                </linearGradient>
                <clipPath id="clip0_3288_32159">
